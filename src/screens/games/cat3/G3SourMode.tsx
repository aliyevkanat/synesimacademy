...
export default function G3SourMode({ onLearn, onQuiz, onHome }: Props) {
  const cards = [
            ...
            if (!card.locked) {
              return (
                ...
                >
                  <div
                    style={{
                      background: "linear-gradient(145deg, #9CCC65 0%, #7CB342 50%, #558B2F 100%)",
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        src="/assets/tasty/lemon_sour.png"
                        alt="Қышқыл"
                        style={{ width: 100, height: 100, objectFit: "contain" }}
                      />
                    </div>
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 10px 36px rgba(85,139,47,0.22)",
                }}
              >
                <div
                  style={{
                    padding: "18px 20px 14px",
                    background: "linear-gradient(90deg, #F1F8E9 0%, #ffffff 72%)",
                ...
                >
                  ...
                  <p style={{ margin: "8px 0 0 44px", fontSize: 14, fontWeight: 700, color: "#689F38" }}>
                    Тәтті / қышқыл
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    <img
                      src="/assets/tasty/ice_cream_sweet.png"
                      alt="Тәтті"
                      draggable={false}
                    ...
                    <img
                      src="/assets/tasty/cucumber_sour.png"
                      alt="Қышқыл"
                      draggable={false}
                      style={{ width: 96, height: 96, objectFit: "contain", flexShrink: 0 }}
                    />
